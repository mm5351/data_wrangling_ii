...
table_marj =   
  table_list[[1]] %>% 
    ...
    as_tibble()
```
slice to take out first row
[[]] for which table to extract
...
To get reviews on other pages, change "pageNumber=1" at end of URL to another number
...
GET is one of the four core API calls, go to this website and get the information 
